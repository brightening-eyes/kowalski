...
#include "kwl_soundengine_iphone.h"
...
kwlSoundEngine* soundEngine; //TODO: remove this?


kwlError kwlSoundEngine_hostSpecificInitialize(kwlSoundEngine* engine, 
                                               int sampleRate, 
                                               int numOutChannels, 
                                               int numInChannels, 
                                               int bufferSize)
                              ...
                              const void *inPropertyValue)
{
    ...
    kwlSoundEngine* engine = (kwlSoundEngine*)inUserData;
                                ...
                                AudioBufferList *ioData)
{
    ...
    kwlSoftwareMixer* const mixer = (kwlSoftwareMixer*)inRefCon;
...
//#define KWL_DEBUG_CA_DEADLINE
    ...
    while (currFrame < inNumberFrames)
    {
        ...
        kwlSoftwareMixer_render(mixer, mixer->outBuffer, numFramesToMix);
