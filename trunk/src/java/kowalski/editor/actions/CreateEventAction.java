 ...
 *
 */
public class CreateEventAction extends AbstractProjectDataAction
{
    private String defaultID = "new_event";
    private EventGroup containingGroup;
    private Event createdEvent;
    public CreateEventAction(KowalskiProject p, EventGroup group)
    {
        super(p, "Create Event");
    ...
    {
        createdEvent = 
                ProjectDataUtils.createAndAddEvent(project, containingGroup, defaultID);
    ...
    {
        ProjectDataUtils.removeEvent(project, containingGroup, createdEvent);
    }
