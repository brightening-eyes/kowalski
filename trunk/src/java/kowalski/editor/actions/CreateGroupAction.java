 ...
 *
 */
public class CreateGroupAction extends AbstractProjectDataAction
{
    private String defaultID;
    private NodeWithIDAndComments containingGroup;
    private NodeWithIDAndComments createdEventGroup;

    public CreateGroupAction(KowalskiProject p, 
                             NodeWithIDAndComments group,
                             String id)
    {
        super(p, "Create " + group.getClass().getSimpleName());
    ...
    {
        System.out.println("performing create group");
        createdEventGroup =
                ProjectDataUtils.createAndAddGroup(project, containingGroup, defaultID);
    ...
    {
        ProjectDataUtils.removeGroup(project, containingGroup, createdEventGroup);
    }
}
